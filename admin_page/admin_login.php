...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt === false) {
        error_log("Error fetching admin user: " . print_r(sqlsrv_errors(), true));
        ...
        if ($user && password_verify($password, $user['password'])) {
            if ($user['is_admin']) {
                ...
                $message = "អ្នកមិនមានសិទ្ធិចូលជាអ្នកគ្រប់គ្រងទេ។";
            }
        } else {
            $message = "ឈ្មោះអ្នកប្រើប្រាស់ ឬពាក្យសម្ងាត់មិនត្រឹមត្រូវ។";
        }
...
<head>
    ...
    <title>ចូលអ្នកគ្រប់គ្រង - ហាងឌីជីថល</title>
...
<body class="bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">ចូលអ្នកគ្រប់គ្រង</h2>
        <?php if ($message): ?>
